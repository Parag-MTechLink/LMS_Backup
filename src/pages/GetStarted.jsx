...
import { User, Mail, Lock, Briefcase, ArrowRight, X, Info } from 'lucide-react'
              ...
              <div>
                ...
                <div className="mt-4 group relative inline-block">
                  <div className="flex items-center gap-1.5 text-[11px] font-medium text-slate-400 cursor-pointer transition-colors hover:text-slate-600">
                    <div className="flex h-4 w-4 items-center justify-center rounded-full bg-slate-100 text-slate-500 transition-colors group-hover:bg-slate-200">
                  ...
                  <div className="absolute left-0 top-full mt-2 hidden group-hover:block transition-all duration-200 animate-in fade-in slide-in-from-top-2 z-50">
                    <div className="rounded-xl border border-slate-200 bg-white p-3 shadow-xl min-w-[200px]">
                      <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-2 border-b border-slate-50 pb-1.5">
                        Authorized Domains
                      </p>
                      <ul className="space-y-1.5">
                        {ALLOWED_DOMAINS.map(domain => (
                          <li key={domain} className="flex items-center gap-2 text-[11px] text-slate-600 whitespace-nowrap leading-none py-0.5">
